                    ...
                    <div className="block-content">
                        <ol id="compare-items">
                            <li className="item odd">
                                ...
                                <a className="btn-remove1" title="Remove This Item" href="/grid"></a> <a href="/grid" className="product-name"> Sofa with Box-Edge Polyester Wrapped Cushions</a> 
                            </li>
                            <li className="item last even">
                                <input type="hidden" value="2174" className="compare-item-id" />
                                <a className="btn-remove1" title="Remove This Item" href="/grid"></a> <a href="/grid" className="product-name"> Sofa with Box-Edge Down-Blend Wrapped Cushions</a> 
                            </li>
                        </ol>
