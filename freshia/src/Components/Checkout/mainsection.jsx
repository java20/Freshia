                                    ...
                                    <form id="co-billing-form" action="">
                                        <fieldset className="group-select">
                                            <ul>
                                                ...
                                                <li>
                                                    <input type="radio" name="billing[use_for_shipping]" id="billing:use_for_shipping_yes" value="1" onClick="$('shipping:same_as_billing').checked = true;" className="radio" />&nbsp;
                                                                <label for="billing:use_for_shipping_yes">Ship to this address</label>&nbsp;
                                                                <input type="radio" name="billing[use_for_shipping]" id="billing:use_for_shipping_no" value="0" checked="checked" onClick="$('shipping:same_as_billing').checked = false;" className="radio" />&nbsp;
                                            ...
                                            <button type="button" className="button continue" onClick="billing.save()"><span>Continue</span></button>
                                        </fieldset>
                                    </form>
                                </div>
                            </li>
                            <li id="opc-shipping" className="section">
                                <div className="step-title"> <span className="number">2</span>
                                    <h3 className="one_page_heading"> Shipping Information</h3>
                                </div>
                            </li>
                            <li id="opc-shipping" className="section">
                                <div className="step-title"> <span className="number">3</span>
                                    <h3 className="one_page_heading"> Method</h3>
                                </div>
                            </li>
                            <li id="opc-shipping" className="section">
                                <div className="step-title"> <span className="number">4</span>
                                    <h3 className="one_page_heading"> Payment Information</h3>
                                </div>
                            </li>
                            <li id="opc-shipping" className="section">
                                <div className="step-title"> <span className="number">5</span>
