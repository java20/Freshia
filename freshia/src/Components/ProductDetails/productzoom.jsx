                            ...
                            <form action="#" method="post" id="product_addtocart_form">
                                ...
                                <div className="product-img-box col-lg-4 col-sm-5 col-xs-12">
                                    ...
                                    <div className="product-image">
                                        <div className="product-full"> <img id="product-zoom" src={process.env.PUBLIC_URL + '/assets/images/product16.jpg'} data-zoom-image={process.env.PUBLIC_URL + '/assets/images/product16.jpg'} alt="product-image" /> </div>
                                        ...
                                        <div className="add-to-cart">
                                            <div className="pull-left">
                                                <div className="custom pull-left">
                                                    ...
                                                    <input type="text" className="input-text qty" title="Qty" value={this.state.quantity} maxLength="12" id="qty" name="qty" onChange={this.handleInputQuantity} />
