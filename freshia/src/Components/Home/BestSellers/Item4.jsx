                    ...
                    <div className="item-inner">
                        <div className="item-img">
                            <div className="item-img-info"> <a className="product-image" title="Retis lapen casen"
                                href="/productdetails"> <img alt="Retis lapen casen" src={process.env.PUBLIC_URL + '/assets/images/product13.jpg'} />  {/**Img */}
                            </a>
                            ...
                            <div className="info-inner">
                                ...
                                <div className="item-content">
                                    ...
                                    <div className="item-price">
                                        <div className="price-box"> <span className="regular-price"> <span className="price">$225.00</span>
                                        </span> </div>
                                    </div>
