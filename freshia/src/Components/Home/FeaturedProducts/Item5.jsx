                    ...
                    <div className="item-inner">
                        <div className="item-img">
                            <div className="item-img-info"> <a className="product-image" title="Retis lapen casen"
                                href="/productdetail"> <img alt="Retis lapen casen" src={process.env.PUBLIC_URL + '/assets/images/product5.jpg'} />
                            </a>
                        ...
                        <div className="item-info">
                            <div className="info-inner">
                                <div className="item-title"> <a title="Retis lapen casen" href="/productdetail"> Retis lapen
                            casen </a> </div>
                                <div className="item-content">
                                    ...
                                    <div className="item-price">
                                        <div className="price-box"> <span className="regular-price"> <span className="price">$525.00</span>
                                        </span> </div>
                                    </div>
