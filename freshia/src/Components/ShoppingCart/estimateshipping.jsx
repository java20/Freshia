                        ...
                        <div className='shipping-form'>
                            <form id="shipping-zip-form" method="post" action="#estimatePost/">
                                ...
                                <ul className='form-list'>
                                    <li>
                                        <label className="required" for="country"><em>*</em>Country</label>
                                    ...
                                    <li>
                                        ...
                                        <div className="input-box">
                                            <select title="State/Province" name="region_id" id="region_id" defaultvalue="" className="required-entry validate-select">
                                            ...
                                            <input type="text" style={{ display: 'none' }} className="input-text required-entry" title="State/Province" value="" name="region" id="region" />
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <div class="buttons-set11">
                                    <button className="button get-quote" onclick="coShippingMethodForm.submit()" title="Get a Quote" type="button"><span>Get a Quote</span></button>
                                </div>
                            </form>
                        </div>
                    </div>
