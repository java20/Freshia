...
class headercurrency extends Component {
    render() {
        return (
            <div className="dropdown block-currency-wrapper"> <a role="button" data-toggle="dropdown" className="block-currency dropdown-toggle" href="#/"> USD <span className="caret"></span></a>
