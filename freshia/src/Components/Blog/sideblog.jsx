                ...
                <div className="col-right sidebar col-sm-3 bounceInUp animated">
                    <div role="complementary" className="widget_wrapper13" id="secondary">
                                ...
                                <ul className="posts-list unstyled clearfix">
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog" src={process.env.PUBLIC_URL + '/assets/images/blog-img1.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog" src={process.env.PUBLIC_URL + '/assets/images/blog-img2.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog" src={process.env.PUBLIC_URL + '/assets/images/blog-img3.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog" src={process.env.PUBLIC_URL + '/assets/images/blog-img4.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
