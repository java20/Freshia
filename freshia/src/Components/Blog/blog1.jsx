                ...
                <article className="blog_entry clearfix wow bounceInUp animated" id="post-29">
                    <header className="blog_entry-header clearfix">
                        <div className="blog_entry-header-inner">
                            <h2 className="blog_entry-title"> <a rel="bookmark" href="/blogdetail">Aliquam eget
                              sapien placerat</a> </h2>
                        </div>
                        {/* blog_entry-header-inner */}
                    </header>
                    <div className="entry-content">
                        <div className="featured-thumb"><a href="/blogdetail"><img alt="blog-img3"
                            src={process.env.PUBLIC_URL + '/assets/images/blog-img3.jpg'} /></a></div>
                        <div className="entry-content">
