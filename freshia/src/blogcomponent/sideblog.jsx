...
import bannerimg from '../images/hot-trends-banner.jpg'
                ...
                <div className="col-right sidebar col-sm-3 bounceInUp animated">
                    <div role="complementary" className="widget_wrapper13" id="secondary">
                        <div className="popular-posts widget widget__sidebar wow bounceInUp animated" id="recent-posts-4">
                            ...
                            <div className="widget-content">
                                <ul className="posts-list unstyled clearfix">
                                    <li>
                                        <figure className="featured-thumb"> <a href="blog_single_post.html"> <img width="80" height="53"
                                            alt="blog image" src={img1} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="blog_single_post.html"> <img width="80" height="53"
                                            alt="blog image" src={img2} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="blog_single_post.html"> <img width="80" height="53"
                                            alt="blog image" src={img3} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="blog_single_post.html"> <img width="80" height="53"
                                            alt="blog image" src={img4} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        {/* Banner Ad Block */}
                        <div className="hot-banner"><img alt="banner" src={bannerimg} /></div>
                        {/* Banner Text Block */}
