                ...
                <article class="blog_entry clearfix wow bounceInUp animated" id="post-29">
                    <header class="blog_entry-header clearfix">
                        <div class="blog_entry-header-inner">
                            <h2 class="blog_entry-title"> <a rel="bookmark" href="blog_single_post.html">Dolor lorem
                              ipsum</a> </h2>
                        </div>
                        {/* blog_entry-header-inner */}
                    </header>
                    <div class="entry-content">
                        <div class="featured-thumb"><a href="blog_single_post.html"><img alt="blog-img2"
                            src={Blogimg2} /></a></div>
                        <div class="entry-content">
