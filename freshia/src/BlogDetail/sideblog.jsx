            ...
            <div className="popular-posts widget widget__sidebar wow bounceInUp animated" id="recent-posts-4">
              ...
              <div className="widget-content">
                <ul className="posts-list unstyled clearfix">
                  <li> <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53" alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img1.jpg'} /> </a> </figure>
                    {/* featured-thumb */}
                  ...
                  <li>
                     <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53" alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img2.jpg'} /> </a> </figure>
                    {/* featured-thumb */}
                  ...
                  <li>
                     <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53" alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img3.jpg'} /> </a> </figure>
                    {/* featured-thumb */}
                  ...
                  <li>
                     <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53" alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img4.jpg'} /> </a> </figure>
                    {/* featured-thumb */}
