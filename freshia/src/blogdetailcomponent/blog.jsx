                                ...
                                <div role="main" id="content">
                                    <article className="blog_entry clearfix" id="post-29">
                                        ...
                                        <div className="entry-content">
                                            <div className="featured-thumb"><a href="#"><img alt="blog-img4" src={BlogImg1} /></a></div>
                                            <div className="entry-content">
                      ...
                      . </footer>
                              ...
                              . </div>
                                                ...
                                                <li className="comment">
                                                    <div className="comment-wrapper" id="post-29">
                                                        <div className="comment-author vcard">
                                                            <p className="gravatar"><a href="#"><img width="60" height="60" alt="avatar" src={Member2} /></a></p>
                                                            <span className="author">John Doe</span> </div>
                                                        {/* comment-author vcard */}
                                                        <div className="comment-meta">
                              ...
                              . </div>
                                                ...
                                                <li className="comment">
                                                    <div className="comment-wrapper" id="post-29">
                                                        <div className="comment-author vcard">
                                                            <p className="gravatar"><a href="#"><img width="60" height="60" alt="avatar" src={Member3} /></a></p>
                                                            <span className="author">John Doe</span> </div>
                                                        {/* comment-author vcard */}
                                                        <div className="comment-meta">
                                        ...
                                        <div className="comments-form-wrapper clearfix">
                                            ...
                                            <form className="comment-form" method="post" id="postComment" action="">
                                                <div className="field">
                                                    ...
                                                    <input type="text" className="input-text" title="Name" value="" id="user" name="user_name" />
                                                </div>
                                                <div className="field">
                                                    <label for="email">Email<em className="required">*</em></label>
                                                    <input type="text" className="input-text validate-email" title="Email" value="" id="email" name="user_email" />
                                                </div>
                                                <div className="clear"></div>
                                                <div className="field aw-blog-comment-area">
                                                    <label for="comment">Comment<em className="required">*</em></label>
                                                    <textarea rows="5" cols="50" className="input-text" title="Comment" id="comment" name="comment"></textarea>
                                                </div>
