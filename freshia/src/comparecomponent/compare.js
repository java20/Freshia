                                    ...
                                    <table className=" data-table compare-table">
                                        ...
                                        <tbody>
                                            <tr className="product-shop-row first odd">
                                                <th>&nbsp;</th>
                                                <td><a href="#" className="btn btn-cancel" title="Remove This Item"><i className="fa fa-remove"></i></a> <a className="product-image" href="#" title="Azrouel Dress"><img src={Product1} alt="Azrouel Dress" width="200" /></a>
                                                ...
                                                <td><a href="#" className="btn btn-cancel" title="Remove This Item"><i className="fa fa-remove"></i></a><a className="product-image" href="#" title="Blue Lagoon polka-dot chiffon and lace thong"><img src={Product2} alt="Azrouel Dress" width="200" /></a>
