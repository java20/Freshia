...
export class headerlang extends Component {
    render() {
        return (
                <div className="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" className="block-language dropdown-toggle" href="#/"> <img src={EnglishImg} alt="language"/> English <span className="caret"></span> </a>
