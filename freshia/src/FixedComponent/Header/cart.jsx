                            ...
                            <div className="top-cart-content">
                                ...
                                <ul className="mini-products-list" id="cart-sidebar">
                                    <li className="item first">
                                        <div className="item-inner"> <a className="product-image" title="Retis lapen casen" href="#/"><img alt="Retis lapen casen" src={process.env.PUBLIC_URL + '/assets/images/product4.jpg'} /> </a>
                                    ...
                                    <li className="item last">
                                        <div className="item-inner"> <a className="product-image" title="Retis lapen casen" href="product_detail.html"><img alt="Retis lapen casen" src={process.env.PUBLIC_URL + '/assets/images/product3.jpg'} /> </a>
                                            <div className="product-details">
                                                <div className="access"><a className="btn-remove1" title="Remove This Item" href="#/">Remove</a> <a className="btn-edit" title="Edit item" href="#/"><i className="icon-pencil"></i><span className="hidden">Edit item</span></a> </div>
