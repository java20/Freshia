                    ...
                    <div className="container">
                        <div className="header-nav-dropdown-wrapper clearer">
                            <div className="grid12-3">
                                <div><img src={process.env.PUBLIC_URL + '/assets/images/custom-img1.jpg'} alt="custom-image" /> </div>
                            ...
                            <div className="grid12-3">
                                <div><img src={process.env.PUBLIC_URL + '/assets/images/custom-img2.jpg'} alt="custom-image" /> </div>
                            ...
                            <div className="grid12-3">
                                <div><img src={process.env.PUBLIC_URL + '/assets/images/custom-img3.jpg'} alt="custom-image" /> </div>
                                <h4 className="heading">Hot Deals!</h4>
                                <p>Our font delivery service is built upon a reliable, global network of servers.</p>

                            </div>
                            <div className="grid12-3">
                                <div><img src={process.env.PUBLIC_URL + '/assets/images/custom-img4.jpg'} alt="custom-image" /> </div>
