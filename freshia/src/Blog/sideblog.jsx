                ...
                <div className="col-right sidebar col-sm-3 bounceInUp animated">
                    <div role="complementary" className="widget_wrapper13" id="secondary">
                        <div className="popular-posts widget widget__sidebar wow bounceInUp animated" id="recent-posts-4">
                            ...
                            <div className="widget-content">
                                <ul className="posts-list unstyled clearfix">
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img1.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
                                        ...
                                        <p className="post-meta"><i className="fa fa-calendar-o"></i>&nbsp;&nbsp;
                                            <time datetime="2014-07-10T07:09:31+00:00" className="entry-date">Jul 10, 2014</time>
                        .</p>
                                    </li>
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img2.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img3.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
                        ...
                        .</p>
                                    ...
                                    <li>
                                        <figure className="featured-thumb"> <a href="/blogdetail"> <img width="80" height="53"
                                            alt="blog image" src={process.env.PUBLIC_URL + '/assets/images/blog-img4.jpg'} /> </a> </figure>
                                        {/* featured-thumb */}
                                        <h4><a title="Pellentesque habitant morbi" href="#/pellentesque-habitant-morbi">Pellentesque
                          habitant morbi</a></h4>
                                        <p className="post-meta"><i className="fa fa-calendar-o"></i>&nbsp;&nbsp;
                                            <time datetime="2014-07-10T06:53:43+00:00" className="entry-date">Jul 10, 2014</time>
                        .</p>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="text-widget widget widget__sidebar">
                            ...
                            <div className="widget-content">Mauris at blandit erat. Nam vel tortor non quam scelerisque cursus. Praesent
                  ...
                  neque sapien, sollicitudin non ornare quis, malesuada.</div>
                        </div>
                    </div>
                </div>
            </>
