...
import Product3 from '../products-images/product5.jpg'
                                            ...
                                            <table id="wishlist-table" className="clean-table linearize-table data-table">
                                                ...
                                                <tbody>
                                                    <tr id="item_31" className="first odd">
                                                        <td className="wishlist-cell0 customer-wishlist-item-image"><a title="Softwear Women's Designer" href="#/" className="product-image"> <img width="150" alt="Softwear Women's Designer" src={Product1} /> </a></td>
                                                    ...
                                                    <tr id="item_33" className="odd">
                                                        <td className="wishlist-cell0 customer-wishlist-item-image"><a title="Softwear Women's Designer" href="#" className="product-image"> <img width="150" alt="Softwear Women's Designer" src={Product2} /> </a></td>
                                                        <td className="wishlist-cell1 customer-wishlist-item-info"><h3 className="product-name"><a title="Softwear Women's Designer" href="#">Softwear Women's Designer</a></h3>
                                                            <div className="description std">
                                                                <div className="inner">A Black Multi-Coloured Printed Leggings for Women from Softwear.</div>
                                                            </div>
                                                    ...
                                                    <tr id="item_32" className="last even">
                                                        <td className="wishlist-cell0 customer-wishlist-item-image"><a title="Slim Fit Casual Shirt" href="#" className="product-image"> <img width="150" alt="Slim Fit Casual Shirt" src={Product3} /> </a></td>
